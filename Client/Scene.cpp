...
void CScene::BuildDefaultLightsAndMaterials()
{
	...
	m_pLights[5].m_fRange = 10.0f;
	m_pLights[5].m_xmf4Ambient = XMFLOAT4(1.0f, 0.5f, 0.0f, 1.0f);
	m_pLights[5].m_xmf4Diffuse = XMFLOAT4(1.0f, 0.5f, 0.0f, 0.8f);
	m_pLights[5].m_xmf4Specular = XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f);
	m_pLights[5].m_xmf3Position = XMFLOAT3(0.0f, 0.0f, 0.0f);
	m_pLights[5].m_xmf3Direction = XMFLOAT3(0.0f, 1.0f, 0.0f);
	m_pLights[5].m_xmf3Attenuation = XMFLOAT3(1.0f, 0.01f, 0.0001f);
	m_pLights[5].m_fFalloff = 5.0f;
	m_pLights[5].m_fPhi = (float)cos(XMConvertToRadians(60.0f));
	m_pLights[5].m_fTheta = (float)cos(XMConvertToRadians(20.0f));
	m_pLights[5].m_bEnable = true;

	m_pLights[6].m_nType = POINT_LIGHT;
	m_pLights[6].m_fRange = 10.0f;
	m_pLights[6].m_xmf4Ambient = XMFLOAT4(1.0f, 0.5f, 0.0f, 1.0f);
	m_pLights[6].m_xmf4Diffuse = XMFLOAT4(1.0f, 0.5f, 0.0f, 0.8f);
	m_pLights[6].m_xmf4Specular = XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f);
	m_pLights[6].m_xmf3Position = XMFLOAT3(0.0f, 0.0f, 0.0f);
	m_pLights[6].m_xmf3Direction = XMFLOAT3(0.0f, 1.0f, 0.0f);
	m_pLights[6].m_xmf3Attenuation = XMFLOAT3(1.0f, 0.01f, 0.0001f);
	m_pLights[6].m_fFalloff = 5.0f;
	m_pLights[6].m_fPhi = (float)cos(XMConvertToRadians(60.0f));
...
void CScene::AnimateObjects(float fTimeElapsed)
{
	...
	if (m_pLights)
	{
		...
		m_pLights[5].m_xmf3Position = m_ppGameObjects[0]->GetPosition();
		m_pLights[5].m_xmf3Direction = m_ppGameObjects[0]->GetUpVector();
		XMStoreFloat3(&offset, XMVectorAdd(XMLoadFloat3(&m_ppGameObjects[0]->GetPosition()), XMLoadFloat3(&offset)));

		m_pLights[6].m_xmf3Position = m_ppGameObjects[1]->GetPosition();
		m_pLights[6].m_xmf3Direction = m_ppGameObjects[1]->GetUpVector();
		XMStoreFloat3(&offset, XMVectorAdd(XMLoadFloat3(&m_ppGameObjects[1]->GetPosition()), XMLoadFloat3(&offset)));
	}
