...
void CGameFramework::CreateDirect2DDevice()
{
	...
	hResult = m_pdWriteFactory->CreateTextFormat(L"µ¸¿òÃ¼", NULL, DWRITE_FONT_WEIGHT_DEMI_BOLD, DWRITE_FONT_STYLE_ITALIC, DWRITE_FONT_STRETCH_NORMAL, 48.0f, L"en-US", &m_pdwFont);
	...
	hResult = m_pdWriteFactory->CreateTextLayout(L"ÅØ½ºÆ® ·¹ÀÌ¾Æ¿ô", 8, m_pdwFont, 4096.0f, 4096.0f, &m_pdwTextLayout);
